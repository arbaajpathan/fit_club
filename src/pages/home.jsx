    ...
    <div>
      ...
      <section className="section__container member__container">
        ...
        <div className="member__image">
          <img id="mem1" src={member} alt="member" style={{ height: '400px', width: '400px', borderRadius: '20px' }} />
          <img id="mem2" src={member2} alt="member2" style={{ height: '400px', width: '400px', borderRadius: '20px', marginLeft: '450px', marginTop: '-400px' }} />
          <img id="mem3" src={member3} alt="member3" style={{ height: '400px', width: '400px', borderRadius: '20px', marginLeft: '900px', marginTop: '-400px' }} />
          <span className="bg__blur"></span>
        </div>
      </section>
