...
import abimg from '../assets/aboutone.jpg'
import about_head_img from '../assets/ab.png'
import abimg2 from '../assets/abouttwo.jpg'
function about() {
  return (
    <div>
      <nav>
      ...
      <img className='abimage' src={about_head_img} alt="about_head_img" style={{ width: '800px', height: '800px', marginLeft: '780px', marginTop: '-20px', }} />
      ...
      <section className='about_content2'>
        ...
        <div className='about_content2_2'>
          ...
          <img className='abimage' style={{ borderRadius: "20px", marginLeft: "30px", fontFamily: "sans-serif", width: "500px", height: "400px", objectFit: "cover" }}
            src={abimg}>
          </img>
      ...
      <section className='about_content3'>
        ...
        <div className='container' style={{ marginTop: "-500px" }}>
          ...
          <br />
          <img style={{ borderRadius: "20px", marginLeft: "410px", fontFamily: "sans-serif", width: "500px", height: "400px", objectFit: "cover" }}
            src={abimg2}>
          </img>
        </div>
